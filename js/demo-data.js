...
const DEMO_DATA = (() => {
  ...
  const field_evidence = [
    { intervention_id: 'CD001', photo_url: placeholderPhoto('Field Photo (DEMO)'), photo_date: '2023-08-18', latitude: 11.8035, longitude: 77.8061, description: 'Check dam holding water well after monsoon; new growth on both banks.' },
    { intervention_id: 'CD001', photo_url: placeholderPhoto('Field Photo (DEMO)'), photo_date: '2024-01-05', latitude: 11.8034, longitude: 77.8060, description: 'Downstream field showing improved soil moisture.' },
